...
IF (writeout.EQ.1) THEN
    ...
    CLOSE (unit=9)
!    OPEN (unit=9, file="graphs_simulation_dprob.txt", position="rewind")
!    WRITE (9, *) dprob
!    CLOSE (unit=9)
...
OPEN (unit=9, file="graphs_avg_y.txt", position="rewind")
WRITE (9, '(F15.8)') avg_y
CLOSE (unit=9)

OPEN (unit=9, file="graphs_welf_bindex.txt", position="rewind")
WRITE (9, '(I10)') i
CLOSE (unit=9)

OPEN (unit=9, file="graphs_welfare.txt", position="rewind")
WRITE (9, '(F15.8)') avg_welf_b(i)
CLOSE (unit=9)
