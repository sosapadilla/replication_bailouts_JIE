...
INTEGER :: 	writeout = 1, simulonly = 0, maxiter = 47, runwelf = 0
...
PARAMETER (b_num= 50, y_num = 25, tax_num = 25, transfer_num = 1, epsilon_num = 4, var_e_num = 10)
...
DOUBLE PRECISION :: avg_loan_to_y, avg_transfer_to_y, def_prob_unconditional, def_prob_conditional, &
    ...
    bc_prob_unconditional, avg_var_e, avg_var_e_tranquil, avg_t_ind, avg_var_e_nb
