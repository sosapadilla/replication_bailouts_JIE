...
INTEGER :: 	writeout = 1, simulonly = 0, maxiter = 300, runwelf = 1
...
PARAMETER (sigma = 2d+0, pi_number = 3.1415926535897932d+0, lambda = 0d+0, zero = 0d+0, width = 1.5d+0,     &
    prob_excl_end = 0.5d+0, delta_bond = 1.0d+0, theta=0.5d+0, k=1d+0, mean_y = 0d+0, epsmin = 1.0d+0,        &
    epsmax = EXP(1.0d+0), bankcrisis_prob = 0.0181d+0, rw = 0.04d+0)

! Parameters for "SMM":
DOUBLE PRECISION :: beta = 0.81845299000000005d+0, AA = 0.31265986000000001d+0, gov_spending = 0.14499999999999999d+0,         &
    sig_e = 3.7528921000000000d+0, T_max_frac = 1.0d+0
...
! Pick welfare gain at the simulated average debt level for the summary table.
i = MINVAL(MINLOC(ABS(b_grid-avg_b)))
avg_welf = avg_welf_b(i)
        ...
        DO iter = 1, itermax
            ...
            DO idx_y = 1, y_num
                DO idx_e = 1, epsilon_num
                    ...
                    DO idx_crisis = 1,2
                        ...
                        DO idx_yp = 1,y_num
                            DO idx_ep = 1, epsilon_num
                                ...
                                evpb = evpb + beta_bank*trans_matrix(idx_y, idx_yp)*petran(idx_ep) &
                    ...
                    wdeftemp(idx_y, idx_e) = (1.0d+0 - pi)*evpb1 + pi*evpb
                    ...
                    DO idx_b = 1, b_num
                        ...
                        ELSE
                            ...
                            whati(idx_b, idx_y, idx_e, idx_i) = (1.0d+0 - pi)*evpb1 + pi*evpb
                        ENDIF
...
wage, trans, guarantee, spread_ss, tr_y_elasticity, tr_y_multiplier
