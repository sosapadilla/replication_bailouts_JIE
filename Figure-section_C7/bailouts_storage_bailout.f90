...
PARAMETER (b_num= 50, k_num= 15, y_num =25, tax_num=25, transfer_num = 50, epsilon_num = 4)
...
DOUBLE PRECISION :: sigma, b_inf, b_sup, y_inf, y_sup, eps_inf, eps_sup, std_y, pi_number, lambda,  &
    ...
    ! beta = 0.81232233d+0, 
    ! Parameters for "SMM":
    DOUBLE PRECISION :: gov_spending = 0.14646447d+0, sig_e = 4.2570787d+0, T_max_frac = 1.0d+0
...
! This function computes the expected value of the next period's (1+loan rate) * (1-k_epsilon_frac * eshock).
! So, it's what goes into the expectation found in the RHS of the k' FOC. 
